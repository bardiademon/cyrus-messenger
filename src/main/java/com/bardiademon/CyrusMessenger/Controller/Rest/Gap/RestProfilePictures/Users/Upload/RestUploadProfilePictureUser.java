...
@RestController
@RequestMapping (value = Domain.RNGap.RNProfilePicture.RN_PROFILE_PICTURES_UPLOAD_USER, method = RequestMethod.POST)
public final class RestUploadProfilePictureUser
{
             ...
             @ModelAttribute RequestUploadProfilePictureUser request)
    {
        ...
        String router = Domain.RNGap.RNProfilePicture.RN_PROFILE_PICTURES_UPLOAD_USER;
    ...
    private AnswerToClient upload (RequestUploadProfilePictureUser request , ProfilePictures profilePictures , CheckImage checkImage , MainAccount mainAccount , HttpServletResponse res , HttpServletRequest req , String router , List <AccessLevel.Who> who)
    {
        ...
        try
        {
            ...
            if (!file.exists ())
            {
                ...
                UploadedFiles images = new UploadedFiles ();
                images.setType (type);
                images.setName (name);
                images.setSize (request.getPicture ().getSize ());
                images.setSavedPath (file.getParent ());
                images.setFileFor (RestUploadProfilePictureUser.class.getName ());
