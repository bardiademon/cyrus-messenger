package com.bardiademon.CyrusMessenger.Controller.Rest.Gap.Groups.Security.Management.ChangeManagerAccessLevel;

import com.bardiademon.CyrusMessenger.Controller.AnswerToClient;
import com.bardiademon.CyrusMessenger.Controller.Rest.Gap.Groups.Security.Management.AddManager.RequestNewManager;
...
@RestController
@RequestMapping (value = Domain.RNGap.RNGroups.Security.RN_SECURITY_CHANGE_MANAGER_ACCESS_LEVEL, method = RequestMethod.POST)
public final class RestChangeManagerAccessLevel
{
             ...
             @RequestBody RequestNewManager request)
    {
        ...
        String router = Domain.RNGap.RNGroups.Security.RN_SECURITY_CHANGE_MANAGER_ACCESS_LEVEL;
