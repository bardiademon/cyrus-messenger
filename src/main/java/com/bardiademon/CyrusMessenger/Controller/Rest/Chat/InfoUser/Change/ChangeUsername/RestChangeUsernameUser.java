package com.bardiademon.CyrusMessenger.Controller.Rest.Chat.InfoUser.Change.ChangeUsername;
...
@RestController
@RequestMapping (value = Domain.RNChat.RNInfoUser.RNChange.RN_CHANGE_USERNAME, method = RequestMethod.POST)
public final class RestChangeUsernameUser
{
             ...
             @RequestParam (value = "username") String username)
    {
        ...
        String router = Domain.RNChat.RNInfoUser.RNChange.RN_CHANGE_USERNAME;
