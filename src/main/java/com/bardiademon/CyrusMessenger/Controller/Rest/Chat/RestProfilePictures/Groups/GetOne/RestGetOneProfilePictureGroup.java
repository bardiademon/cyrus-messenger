package com.bardiademon.CyrusMessenger.Controller.Rest.Chat.RestProfilePictures.Groups.GetOne;
...
public final class RestGetOneProfilePictureGroup
{
             ...
             @PathVariable (value = "ID_PROFILE_PICTURE", required = false) String id)
    {
        ...
        String router = Domain.RNChat.RNProfilePicture.RN_PROFILE_PICTURES_GET_ONE_GROUP;
