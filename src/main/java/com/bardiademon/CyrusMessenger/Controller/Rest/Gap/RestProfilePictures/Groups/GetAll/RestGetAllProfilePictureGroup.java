package com.bardiademon.CyrusMessenger.Controller.Rest.Gap.RestProfilePictures.Groups.GetAll;
...
@RestController
@RequestMapping (value = Domain.RNGap.RNProfilePicture.RN_PROFILE_PICTURES_GET_ALL_GROUP, method = RequestMethod.POST)
public final class RestGetAllProfilePictureGroup
{
             ...
             @PathVariable (value = "ID_GROUP") String id)
    {
        ...
        String router = Domain.RNGap.RNProfilePicture.RN_PROFILE_PICTURES_GET_ALL_GROUP;
