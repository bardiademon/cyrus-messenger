package com.bardiademon.CyrusMessenger.Controller.Rest.Gap.Groups.Security.Management.Change.ChangeUsername;
...
@RestController
@RequestMapping (value = Domain.RNGap.RNGroups.RN_CHANGE_USERNAME_GROUP, method = RequestMethod.POST)
public final class RestChangeUsernameGroup
{
             ...
             HttpServletResponse res , HttpServletRequest req , @RequestBody RequestChangeUsernameGroup request)
    {
        ...
        String router = Domain.RNGap.RNGroups.RN_CHANGE_USERNAME_GROUP;
