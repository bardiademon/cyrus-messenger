package com.bardiademon.CyrusMessenger.Controller.Rest.Chat.Groups.Security.Management.FiredMember;
...
@RestController
@RequestMapping (value = Domain.RNChat.RNGroups.Security.RN_SECURITY_FIRED_MEMBER, method = RequestMethod.POST)
public final class RestFiredMember
{
             ...
             @RequestBody RequestFiredMember request)
    {
        ...
        String router = Domain.RNChat.RNGroups.Security.RN_SECURITY_FIRED_MEMBER;
