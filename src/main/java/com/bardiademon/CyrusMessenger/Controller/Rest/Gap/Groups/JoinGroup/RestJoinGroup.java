package com.bardiademon.CyrusMessenger.Controller.Rest.Gap.Groups.JoinGroup;
...
@RestController
@RequestMapping (value = Domain.RNGap.RNGroups.RN_JOIN_GROUP, method = RequestMethod.POST)
                ...
                if (!checkBlockSystem.isBlocked ())
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        else
                        {
                            ...
                            answerToClient.setReqRes (req , res);
                            l.n (reqJson , Domain.RNGap.RNGroups.RN_JOIN_GROUP , null , answerToClient , Thread.currentThread ().getStackTrace () , e , "server error");
                        }
                    }
                }
                else
