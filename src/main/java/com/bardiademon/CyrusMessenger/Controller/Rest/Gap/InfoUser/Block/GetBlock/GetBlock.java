package com.bardiademon.CyrusMessenger.Controller.Rest.Gap.InfoUser.Block.GetBlock;
...
@RestController
@RequestMapping (value = Domain.RNGap.RNInfoUser.RNBlock.RN_GET_BLOCK, method = RequestMethod.POST)
