package com.bardiademon.CyrusMessenger.Controller.Rest.Chat.RestProfilePictures.Groups.Delete;
...
@RestController
@RequestMapping (value = Domain.RNChat.RNProfilePicture.RN_PROFILE_PICTURES_DELETE_GROUP, method = RequestMethod.POST)
public final class RestDeleteProfilePictureGroup
{
             ...
             @RequestBody RequestDeleteProfilePictureGroup request)
    {
        ...
        String router = Domain.RNChat.RNProfilePicture.RN_PROFILE_PICTURES_DELETE_GROUP;
