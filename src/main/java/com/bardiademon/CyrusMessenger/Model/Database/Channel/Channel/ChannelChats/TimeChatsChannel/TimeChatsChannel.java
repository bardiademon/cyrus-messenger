package com.bardiademon.CyrusMessenger.Model.Database.Channel.Channel.ChannelChats.TimeChatsChannel;
...
@Entity
@Table (name = "time_chats_channel")
public class TimeChatsChannel
{
    ...
    public TimeChatsChannel ()
    {
    }

    public TimeChatsChannel (GroupChats groupChats , LocalDateTime timeSend , LocalDateTime timeDelivered , LocalDateTime timeRead)
    {
