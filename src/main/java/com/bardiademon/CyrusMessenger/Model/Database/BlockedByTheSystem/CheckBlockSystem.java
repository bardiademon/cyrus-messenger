...
public final class CheckBlockSystem
{
    ...
    {
        this (IdUser , This.Context ().getBean (BlockedByTheSystemService.class) , _BlockedFor , Des);
    }
    ...
    {
        this (Request , This.Context ().getBean (BlockedByTheSystemService.class) , _BlockedFor , Des);
    }
    ...
    {
        return (This.Context ().getBean (BlockedByTheSystemService.class)).getListBlocksMainAccount ();
    }
}
